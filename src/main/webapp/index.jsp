...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="http://gsocial.kodding.net46.net/index_css.css">
...
<body style="overflow-x:hidden">
  <div class="contenedor">
    ...
    <div class="wrapper"style="padding: 4%;">
        <form id="datos" method="GET" action="http://localhost:8080/spring-rest-client/perfil.jsp">
